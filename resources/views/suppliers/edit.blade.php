...
@section('content')
    ...
    <div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            {{-- Header --}}
            <x-form.header edit="true" :name="$supplier->name" title="Supplier" backRoute="{{ route('suppliers.index') }}"
                detailRoute="{{ route('suppliers.show', $supplier) }}" />

            {{-- Card --}}
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                {{-- Card Header --}}
                <x-form.card-header title="Edit Supplier" type="edit" />
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="lg:col-span-2">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600"><i class="bi bi-info-circle mr-1"></i>Nama lengkap
                                        perusahaan atau supplier</p>
                                    @error('name')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code" id="code"
                                        ...
                                        value="{{ old('code', $supplier->code) }}" required placeholder="Contoh: SUP001">
                                    <p class="mt-2 text-sm text-gray-600"><i class="bi bi-info-circle mr-1"></i>Kode unik
                                        untuk identifikasi supplier</p>
                                    @error('code')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="lg:col-span-2">
                                    ...
                                    <textarea name="address" id="address" rows="3"
                                        ...
                                        placeholder="Alamat lengkap">{{ old('address', $supplier->address) }}</textarea>
                                    <p class="mt-2 text-sm text-gray-600"><i class="bi bi-info-circle mr-1"></i>Alamat
                                        lengkap supplier (opsional)</p>
                                    @error('address')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <input type="text" name="phone" id="phone"
                                            ...
                                            value="{{ old('phone', ltrim($supplier->phone ?? '', '62')) }}"
                                            placeholder="813xxxxxxxx" oninput="formatPhoneNumber(this)" maxlength="15">
                                    </div>
                                    <p class="mt-2 text-sm text-gray-600"><i class="bi bi-info-circle mr-1"></i>Format: 8-13
                                        digit angka (tanpa kode negara)</p>
                                    @error('phone')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email"
                                        ...
                                        value="{{ old('email', $supplier->email) }}" placeholder="supplier@contoh.com">
                                    <p class="mt-2 text-sm text-gray-600"><i class="bi bi-info-circle mr-1"></i>Opsional.
                                        Email untuk komunikasi bisnis</p>
                                    @error('email')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <label class="flex items-center cursor-pointer">
                                    ...
                                    <span class="ml-3">
                                        ...
                                        <span class="block text-xs text-gray-600 mt-1"><i
                                                class="bi bi-info-circle mr-1"></i>Centang jika supplier masih
                                            beroperasi</span>
                                    </span>
                                </label>
                            </div>
