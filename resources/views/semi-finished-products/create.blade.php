...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            {{-- Header --}}
            <x-form.header title="Bahan Setengah Jadi"
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <form
                        action="{{ route('semi-finished-products.store', request()->has('branch_id') ? ['branch_id' => request('branch_id')] : []) }}"
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <div class="lg:col-span-2">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">
                                        <i class="bi bi-info-circle mr-1"></i>Nama bahan setengah jadi hasil produksi
                                        internal
                                    </p>
                                    @error('name')
                                ...
                                <div>
                                    ...
                                    <input readonly type="text" name="code" id="code" value="{{ old('code') }}"
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">
                                        ...
                                        <a href="{{ route('categories.create') }}" target="_blank" rel="noopener"
                                            class="underline ml-1">Tambah kategori</a>
                                    </p>
                                    @error('category_id')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">
                                        ...
                                        <a href="{{ route('units.create') }}" target="_blank" rel="noopener"
                                            class="underline ml-1">Tambah satuan</a>
                                    </p>
                                    @error('unit_id')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        {{-- Stock Mode --}}
                        <div class="mb-6">
                            <label class="block text-sm font-semibold text-gray-700 mb-3">Mode Inisialisasi Stok <span
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <label class="flex items-start p-4 border rounded-xl bg-gray-50 cursor-pointer">
                                    ...
                                    <div>
                                        <div class="font-semibold text-gray-900"><i
                                                class="bi bi-buildings text-green-500 mr-2"></i>Semua Cabang</div>
                                        <div class="text-xs text-gray-600 mt-1">Stok akan diinisialisasi sama di semua
                                            cabang termasuk pusat produksi.</div>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-start p-4 border rounded-xl bg-gray-50 cursor-pointer">
                                    ...
                                    <div>
                                        <div class="font-semibold text-gray-900"><i
                                                class="bi bi-building text-blue-500 mr-2"></i>Cabang Tertentu</div>
                                        <div class="text-xs text-gray-600 mt-1">Stok hanya diinisialisasi untuk cabang yang
                                            dipilih.</div>
                                    </div>
                                </label>
                            </div>
                        ...
                        <div class="mb-6" id="branch-selection"
                            style="display: {{ old('stock_mode', $selectedBranch ? 'selected' : 'all') == 'selected' ? 'block' : 'none' }};">
                            <label for="selected_branch_id" class="block text-sm font-semibold text-gray-700 mb-2">Pilih
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <p class="mt-2 text-sm text-gray-600"><i class="bi bi-info-circle mr-1"></i>Format: JPG,
                                    PNG, GIF. Max: 2MB</p>
                                @error('image')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div id="image-preview-container"
                                    class="d-flex items-center justify-center bg-gray-50 rounded h-32 border-2 border-dashed border-gray-200">
                            ...
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-3">
                                    ...
                                    <span class="block text-xs text-gray-600 mt-1"><i
                                            class="bi bi-info-circle mr-1"></i>Centang jika bahan setengah jadi aktif
                                        digunakan</span>
                                </span>
                            </label>
                        </div>
