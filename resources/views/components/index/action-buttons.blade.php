@props(['view' => false, 'edit' => false, 'delete' => false, 'toggle' => false, 'canEditDelete' => true])
...
<div class="flex items-center gap-2 sm:gap-3">
    ...
    <div x-show="typeof canEditDelete === 'undefined' || canEditDelete" class="flex items-center gap-2 sm:gap-3">
        {{-- Edit --}}
        @if ($edit)
            <a :href="editUrl"
                class="group relative inline-flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9
