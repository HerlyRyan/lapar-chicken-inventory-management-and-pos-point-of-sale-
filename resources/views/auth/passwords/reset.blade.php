                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password" required autocomplete="new-password"
                                class="w-full pl-11 pr-4 py-3.5 rounded-2xl border-2 @error('password') border-red-500 @else border-gray-100 @enderror bg-gray-50/50 focus:bg-white focus:border-orange-500 focus:ring-0 transition-all placeholder:text-gray-400 text-gray-700"
