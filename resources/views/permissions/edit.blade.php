...
<div class="container mx-auto py-8">
    <div class="bg-white rounded shadow p-6 max-w-lg mx-auto">
        <h1 class="text-2xl font-bold mb-4">Edit Hak Akses</h1>
        @if(session('success'))
        ...
        <form action="{{ route('permissions.update', $permission) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="code" id="code" class="form-control" value="{{ old('code', $permission->code) }}" required>
            ...
            <div class="mb-4">
                <div class="form-check">
                    <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" {{ old('is_active', $permission->is_active) ? 'checked' : '' }}>
