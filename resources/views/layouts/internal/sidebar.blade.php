<aside :class="{ 'hidden': !sidebarOpen }" x-cloak x-transition:enter="transition ease-out duration-200"
    ...
    class="w-64 bg-white border-r border-gray-200 shadow-lg md:block transition-all duration-200">
    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <div x-data="{ open: false }" class="rounded-xl">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between px-4 py-3 hover:bg-orange-50 hover:text-orange-600 rounded-xl transition-all duration-200 group text-gray-700">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-8 h-8 flex items-center justify-center rounded-lg bg-gray-100 group-hover:bg-orange-100 transition-colors duration-200">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    <a href="{{ route('raw-materials.stock') }}"
                        class="block px-4 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 text-gray-600 text-sm font-medium transition-colors duration-200">
                        Stok Bahan Mentah
                    </a>
    ...
    <aside class="relative w-64 bg-white h-full shadow-2xl">
        <div class="h-full flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('dashboard') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-orange-50 hover:text-orange-600 transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-orange-50 text-orange-600' : 'text-gray-700' }}">
                    <div
                        class="w-8 h-8 flex items-center justify-center rounded-lg {{ request()->routeIs('dashboard') ? 'bg-orange-100' : 'bg-gray-100' }}">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z" />
                        </svg>
                    </div>
                ...
                <div x-data="{ open: false }" class="rounded-xl">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-medium">PEMBELIAN BAHAN MENTAH</span>
                        </div>
                        <svg class="w-4 h-4 transition-transform duration-200" :class="open ? 'rotate-180' : ''"
                            fill="currentColor" viewBox="0 0 24 24">
                            <path d="M7 10l5 5 5-5z" />
