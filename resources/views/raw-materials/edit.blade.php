            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <form action="{{ route('raw-materials.update', $rawMaterial) }}" method="POST"
                        enctype="multipart/form-data" id="rawMaterialForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="lg:col-span-2">
                                    <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Nama Bahan
                                        Baku <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="code" class="block text-sm font-semibold text-gray-700 mb-2">Kode <span
                                    ...
                                    <select name="unit_id" id="unit_id" required
                                        ...
                                        @foreach ($units as $unit)
                                            <option value="{{ $unit->id }}"
                                                {{ old('unit_id', $rawMaterial->unit_id) == $unit->id ? 'selected' : '' }}>
                                                {{ $unit->unit_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    <label for="supplier_id" class="block text-sm font-semibold text-gray-700 mb-2">Supplier
                                        <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="minimum_stock" id="minimum_stock" min="0"
                                        ...
                                        placeholder="Cth: 10">
                                    <p class="mt-2 text-sm text-gray-600"><i class="bi bi-info-circle mr-1"></i>Stok
                                        minimum untuk peringatan.</p>
                                    @error('minimum_stock')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    <label for="current_stock" class="block text-sm font-semibold text-gray-700 mb-2">Stok
                                        Saat Ini</label>
                                    <input type="number" name="current_stock" id="current_stock" min="0"
                                        ...
                                        placeholder="Cth: 100">
                                    <p class="mt-2 text-sm text-gray-600"><i class="bi bi-info-circle mr-1"></i>Stok saat
                                        ini di pusat produksi.</p>
                                    @error('current_stock')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    <label for="unit_price" class="block text-sm font-semibold text-gray-700 mb-2">Harga
                                        Satuan</label>
                                    <input type="number" name="unit_price" id="unit_price" min="0"
                                        ...
                                        value="{{ old('unit_price', $rawMaterial->unit_price) }}"
                                ...
                                <div>
                                    ...
                                    <div id="previewContainer" class="border rounded-xl p-3 bg-gray-50 text-center"
                                        style="height:140px; border-style:dashed;">
                                        @php
                                            $imagePath = null;
                                        ...
                                        <img id="imagePreview" src="{{ $imagePath }}" alt="Preview"
                                            ...
                                            style="max-height:120px; {{ $imagePath ? 'display:block' : 'display:none' }};">
                                        <div id="imagePreviewText" class="text-sm text-gray-500 mt-3"
                                            style="{{ $imagePath ? 'display:none' : 'display:block' }}">Preview foto</div>
                                    </div>
                                </div>
