...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Kelola stok bahan setengah jadi (universal: pusat/cabang sesuai konteks)</p>
        </div>
        <div>
            <a href="{{ route('semi-finished-distributions.create') }}?branch_id={{ request('branch_id', optional($selectedBranch)->id ?? session('selected_dashboard_branch')) }}" class="btn btn-primary">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ $semiFinishedProducts->where('center_stock', '<=', 0)->count() }}
                            </div>
                        </div>
                        <div class="col-auto">
                            ...
                            <div class="d-grid gap-2">
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="{{ route('semi-finished-distributions.create') }}?product={{ $product->id }}&branch_id={{ request('branch_id', optional($selectedBranch)->id ?? session('selected_dashboard_branch')) }}" 
                                       class="btn btn-sm btn-primary" title="Distribusi">
