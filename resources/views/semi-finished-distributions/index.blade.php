...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50/30 to-red-50/30">
        {{-- Page Header --}}
        <x-index.header title="Distribusi Bahan Setengah Jadi" subtitle="Kelola distribusi dari pusat produksi ke cabang"
            addRoute="{{ route('semi-finished-distributions.create') }}" addText="Buat Distribusi Baru" />
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <div x-data="{
                                            ...
                                            <x-index.action-buttons :view="true" :edit="false" :delete="true" />
                                        </div>
                                    </td>
                                </tr>
                            </template>
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="min-w-0">
                                    <div class="flex items-center justify-between gap-2">
                                        ...
                                        <span class="text-xs text-gray-500" x-text="dist.target_branch?.name ?? '-'"></span>
                                    </div>
