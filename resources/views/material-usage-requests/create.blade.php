                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-gray-600">
                                            <i class="bi bi-info-circle mr-1"></i>Cabang yang melakukan permintaan
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-gray-600">
                                            <i class="bi bi-info-circle mr-1"></i>Tanggal pengajuan saat ini
                                        </p>
                                    </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            id="notes" name="notes" rows="3" placeholder="Opsional: tambahkan catatan tambahan jika diperlukan">{{ old('notes') }}</textarea>
                                        <p class="mt-2 text-sm text-gray-600">
