...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 py-4 sm:py-6">
        <div class="max-w-6xl mx-auto px-3 sm:px-4 lg:px-8">
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="flex items-start sm:items-center gap-2 sm:gap-3 mb-2">
                            <div
                                ...
                                <i class="bi bi-pencil-square text-white text-base sm:text-lg"></i>
                            </div>
                            <div class="min-w-0">
                                ...
                                <p class="text-xs sm:text-sm text-gray-600 mt-1 line-clamp-2">
                                    Ubah data pengajuan penggunaan semi-finished product
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <form action="{{ route('semi-finished-usage-requests.update', $usageRequest->id) }}" method="POST"
    ...
    old(
        ...
        $usageRequest->items
            ->map(
                fn($item) => [
                    'raw_material_id' => $item->semi_finished_product_id,
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $usageRequest->requestingBranch->name }}" readonly>
                                        <input type="hidden" name="requesting_branch_id"
                                            value="{{ $usageRequest->requesting_branch_id }}">
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                            class="w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg sm:rounded-xl bg-gray-50 cursor-not-allowed text-sm"
                                            value="{{ $usageRequest->created_at->format('d/m/Y') }}" readonly>
                                        <p class="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600">
                                    ...
                                    <div>
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('required_date', $usageRequest->required_date->format('Y-m-d')) }}"
                                            required>
                                        <p class="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600">
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('purpose', $usageRequest->purpose) }}"
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Opsional: tambahkan catatan tambahan jika diperlukan">{{ old('notes', $usageRequest->notes) }}</textarea>
                                        <p class="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600">
                                                ...
                                                <tr class="hover:bg-gray-50">
                                                    ...
                                                    <td class="py-2 sm:py-3 px-2 sm:px-4">
                                                        <input type="number" min="1"
                                                            class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border rounded text-xs sm:text-sm"
                                                            x-model="Number(item.quantity)" :name="`items[${index}][quantity]`"
                                                            required>
                                                    </td>
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            <template x-for="(output, index) in outputs" :key="index">
                                                <tr class="hover:bg-gray-50">
                                                    ...
                                                    <td class="py-2 sm:py-3 px-2 sm:px-4">
                                                        <input type="number" min="1"
                                                            x-model="Number(output.planned_quantity)"
                                ...
                                <div class="space-y-4 sm:space-y-6">
                                    <div>
                                        ...
                                        <ol
                                            ...
                                            <li>Ubah informasi pengajuan</li>
                                            <li>Perbarui bahan setengah jadi</li>
                                    ...
                                    <div class="border-t border-gray-200 pt-3 sm:pt-4">
                                        ...
                                        <ul class="list-disc list-inside space-y-1 text-xs sm:text-sm text-gray-700 ml-1">
                                            ...
                                            <li>Perubahan akan tercatat</li>
                                            <li>Periksa sebelum menyimpan</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-lg sm:rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                            <div class="p-4 sm:p-6 lg:p-8">
                                <div class="flex flex-col gap-2 sm:gap-3">
                                    <button type="submit"
                                        class="w-full inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-700 border border-transparent rounded-lg sm:rounded-xl text-xs sm:text-sm font-medium text-white hover:from-blue-700 hover:to-blue-800 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-lg hover:shadow-xl">
                                        <i class="bi bi-check-circle mr-1 sm:mr-2 text-sm sm:text-base"></i>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('usageRequestForm', (data) => ({
            ...
            nextKey: Math.max(...data.items.map(item => item.key), 0) + 1,
