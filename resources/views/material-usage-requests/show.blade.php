                ...
                <div class="flex items-center justify-between gap-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-orange-200 mt-1">#{{ $materialUsageRequest->request_number }} —
                                {{ $materialUsageRequest->requested_date->format('d/m/Y') }}</p>
                        </div>
                    </div>
                        ...
                        @if ($materialUsageRequest->status === \App\Models\SemiFinishedUsageRequest::STATUS_PENDING)
                            @if (auth()->user()->hasRole(['kepala-gudang', 'admin', 'super-admin']))
                                <button onclick="openModal('approveModal')"
                                    class="inline-flex items-center px-4 py-2.5 bg-green-600 hover:bg-green-500 text-white rounded-xl font-medium transition-all duration-200 border border-green-700/30">
                                ...
                                <button onclick="openModal('rejectModal')"
                                    class="inline-flex items-center px-4 py-2.5 bg-red-600 hover:bg-red-500 text-white rounded-xl font-medium transition-all duration-200 border border-red-700/30">
                                    <svg class="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @if (auth()->user()->id === $materialUsageRequest->user_id)
                                <a href="{{ route('semi-finished-usage-requests.edit', $materialUsageRequest) }}"
                                    class="inline-flex items-center px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl font-medium transition-all duration-200 border border-white/20">
                                    <svg class="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <button onclick="openModal('cancelModal')"
                                    class="inline-flex items-center px-4 py-2.5 bg-gray-700 hover:bg-gray-600 text-white rounded-xl font-medium transition-all duration-200 border border-gray-700/30">
                                    <svg class="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                        ...
                        @if ($materialUsageRequest->status === \App\Models\SemiFinishedUsageRequest::STATUS_APPROVED)
                            @if (auth()->user()->hasRole(['kepala-gudang', 'admin', 'super-admin']))
                                <button onclick="openModal('processModal')"
                                    class="inline-flex items-center px-4 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-medium transition-all duration-200 border border-indigo-700/30">
                                    <svg class="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @if ($materialUsageRequest->status === \App\Models\SemiFinishedUsageRequest::STATUS_PROCESSING)
                            @if (auth()->user()->hasRole(['kepala-gudang', 'admin', 'super-admin']))
                                <button onclick="openModal('completeModal')"
                                    class="inline-flex items-center px-4 py-2.5 bg-amber-600 hover:bg-amber-500 text-white rounded-xl font-medium transition-all duration-200 border border-amber-700/30">
                                    <svg class="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 12l2 2 4-4" />
                                    </svg>
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Informasi lengkap tentang permintaan penggunaan
                                        bahan</p>
                                </div>
                            ...
                            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-3">
                                    <div class="flex items-start">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg flex items-center justify-center mr-4 text-white">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <div class="font-medium text-gray-800">
                                                {{ $materialUsageRequest->request_number }}</div>
                                        </div>
                                    </div>

                                    <div class="flex items-start">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-4 text-white">
                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M3 3h18v2H3zM3 7h18v14H3z" />
                                            </svg>
                                        </div>
                                        <div>
                                            <div class="text-sm text-gray-500">Cabang Peminta</div>
                                            <div class="font-medium text-gray-800">
                                                {{ $materialUsageRequest->requestingBranch->name }}</div>
                                        </div>
                                    </div>

                                    <div class="flex items-start">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mr-4 text-white">
                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M12 12a5 5 0 100-10 5 5 0 000 10zM21 21a9 9 0 10-18 0" />
                                            </svg>
                                        </div>
                                        <div>
                                            <div class="text-sm text-gray-500">Pengaju</div>
                                            <div class="font-medium text-gray-800">{{ $materialUsageRequest->user->name }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-lg flex items-center justify-center mr-4 text-white">
                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-medium text-gray-800">
                                                {{ $materialUsageRequest->requested_date->format('d/m/Y') }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-start">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-yellow-500 to-amber-500 rounded-lg flex items-center justify-center mr-4 text-white">
                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M12 2l4 7H8l4-7zM5 22h14v-2H5v2z" />
                                            </svg>
                                        </div>
                                        <div>
                                            <div class="text-sm text-gray-500">Tanggal Dibutuhkan</div>
                                            <div class="font-medium text-gray-800">
                                                {{ $materialUsageRequest->required_date ? $materialUsageRequest->required_date->format('d/m/Y') : '-' }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mr-4 text-white">
                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M12 7a2 2 0 100-4 2 2 0 000 4zM6 14v2h12v-2H6z" />
                                            </svg>
                                        </div>
                                        <div>
                                            <div class="text-sm text-gray-500">Tujuan</div>
                                            <div class="font-medium text-gray-800">{{ $materialUsageRequest->purpose }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-gray-500 to-gray-600 rounded-lg flex items-center justify-center mr-4 text-white">
                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <div class="flex items-start">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg flex items-center justify-center mr-4 text-gray-700">
                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M4 6h16v2H4zM4 12h10v2H4zM4 18h16v2H4z" />
                                            </svg>
                                        </div>
                                        <div>
                                            <div class="text-sm text-gray-500">Catatan</div>
                                            <div class="font-medium text-gray-800">
                                                {{ $materialUsageRequest->notes ?: '-' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mt-6 bg-gray-50 p-4 rounded-lg border border-gray-100">
                                    <div class="flex items-center justify-between">
                                        <h3 class="text-sm font-semibold text-gray-800">
                                            @if ($materialUsageRequest->status === \App\Models\SemiFinishedUsageRequest::STATUS_REJECTED)
                                                <span class="text-red-600 inline-flex items-center"><svg
                                                        class="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="currentColor">
                                                        <path
                                                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" />
                                                    </svg>Informasi Penolakan</span>
                                            @else
                                                <span class="text-green-600 inline-flex items-center"><svg
                                                        class="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="currentColor">
                                                        <path
                                                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" />
                                                    </svg>Informasi Persetujuan</span>
                                            @endif
                                        </h3>
                                    </div>
                                    <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                        <div>
                                            ...
                                            <div class="font-medium text-gray-800">
                                                {{ $materialUsageRequest->approval_date ? $materialUsageRequest->approval_date->format('d/m/Y H:i') : '-' }}
                                            </div>
                                            <div class="text-gray-500 mt-2">Oleh</div>
                                            <div class="font-medium text-gray-800">
                                                {{ $materialUsageRequest->approvalUser ? $materialUsageRequest->approvalUser->name : '-' }}
                                            </div>
                                        </div>
                                        <div>
                                            <div class="text-gray-500">Catatan</div>
                                            <div class="font-medium text-gray-800">
                                                {{ $materialUsageRequest->rejection_reason ?: '-' }}</div>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="mt-6">
                                        ...
                                        <thead class="bg-gray-50">
                                            <tr>
                                                ...
                                                <th class="px-4 py-2 text-left text-xs font-medium text-gray-500">Nama
                                                    Bahan</th>
                                                <th class="px-4 py-2 text-right text-xs font-medium text-gray-500">Jumlah
                                                </th>
                                                <th class="px-4 py-2 text-left text-xs font-medium text-gray-500">Satuan
                                                </th>
                                                <th class="px-4 py-2 text-right text-xs font-medium text-gray-500">Harga
                                                    Satuan</th>
                                            ...
                                            @forelse($materialUsageRequest->items as $index => $item)
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-3 text-sm text-gray-700">
                                                        ...
                                                        @if ($item->notes)
                                                            <div class="text-xs text-gray-400 mt-1">{{ $item->notes }}
                                                            </div>
                                                        @endif
                                                    </td>
                                                    <td class="px-4 py-3 text-sm text-right text-gray-700">
                                                        {{ number_format((float) $item->quantity, 0, ',', '.') }}</td>
                                                    <td class="px-4 py-3 text-sm text-gray-700">
                                                        @if ($item->unit)
                                                            {{ $item->unit->name }}@if (!empty($item->unit->symbol))
                                                                ({{ $item->unit->symbol }})
                                                            @endif
                                                        @else
                                                            -
                                                    ...
                                                    <td class="px-4 py-3 text-sm text-right text-gray-700">
                                                        {{ $item->formatted_unit_price }}</td>
                                                    <td class="px-4 py-3 text-sm text-right font-medium text-gray-800">
                                                        {{ $item->formatted_subtotal }}</td>
                                                </tr>
                                                @empty
                                                    <tr>
                                                        <td colspan="6"
                                                            class="px-4 py-6 text-center text-sm text-gray-400">Tidak ada item
                                                        </td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                            <tfoot class="bg-gray-50">
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-3 text-right font-semibold text-gray-800">Rp
                                                        {{ number_format($materialUsageRequest->total_amount, 0, ',', '.') }}
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                ...
                                {{-- Output Items --}}
                                <div class="mt-6">
                                    <h3 class="text-lg font-semibold text-gray-800 mb-3">Daftar Rencana Output</h3>
                                    <div class="overflow-x-auto">
                                        <table class="min-w-full divide-y divide-gray-200 bg-white rounded-lg">
                                            <thead class="bg-gray-50">
                                                <tr>
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-100">
                                                @forelse($materialUsageRequest->outputs as $index => $item)
                                                    <tr>
                                                        <td class="px-4 py-3 text-sm text-gray-700">{{ $index + 1 }}</td>
                                                        <td class="px-4 py-3 text-sm text-gray-700">
                                                        ...
                                                        <td class="px-4 py-3 text-sm text-right text-gray-700">
                                                            {{ number_format((float) $item->planned_quantity, 0, ',', '.') }}
                                                        </td>
                                                        <td class="px-4 py-3 text-sm text-right text-gray-700">
                                                            {{ number_format((float) $item->actual_quantity, 0, ',', '.') }}
                                                        </td>
                                                        <td class="px-4 py-3 text-sm text-gray-700">
                                                            {{ $item->finishedProduct->unit->unit_name ?? '-' }}
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                ...
                                <div class="mt-6">
                                    <a href="{{ route('semi-finished-usage-requests.index') }}"
                                        class="inline-flex items-center px-4 py-2 bg-white/10 hover:bg-white/20 text-gray-800 rounded-xl border border-gray-200">
                                        <svg class="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M15 19l-7-7 7-7" />
                                        </svg>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden">
                            ...
                            <div class="p-6 space-y-4 text-sm">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span
                                        class="text-gray-700">{{ $materialUsageRequest->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-500">Diperbarui</span>
                                    <span
                                        class="text-gray-700">{{ $materialUsageRequest->updated_at->format('d/m/Y H:i') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden">
                            <div class="bg-gradient-to-r from-green-500 to-teal-600 px-6 py-4">
                                <h3 class="text-lg font-bold text-white flex items-center">
                                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16" />
                                    </svg>
                                    Peminta
                                </h3>
                            </div>
                            <div class="p-6 space-y-3">
                                ...
                                @if ($materialUsageRequest->user->phone)
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $materialUsageRequest->user->phone) }}"
                                        target="_blank"
            ...
            <div class="relative bg-white rounded-xl shadow-xl max-w-lg w-full z-10 overflow-hidden">
                <form action="{{ route('semi-finished-usage-requests.approve', $materialUsageRequest) }}" method="POST">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mt-2">Anda yakin ingin menyetujui permintaan penggunaan bahan
                            #{{ $materialUsageRequest->request_number }}?</p>
                        <div class="mt-4">
                    ...
                    <div class="px-6 py-3 bg-gray-50 flex justify-end gap-3">
                        <button type="button" onclick="closeModal('approveModal')"
                            class="px-4 py-2 rounded-md bg-white border">Batal</button>
            ...
            <div class="relative bg-white rounded-xl shadow-xl max-w-lg w-full z-10 overflow-hidden">
                <form action="{{ route('semi-finished-usage-requests.reject', $materialUsageRequest) }}" method="POST">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mt-2">Anda yakin ingin menolak permintaan penggunaan bahan
                            #{{ $materialUsageRequest->request_number }}?</p>
                        <div class="mt-4">
            ...
            <div class="relative bg-white rounded-xl shadow-xl max-w-lg w-full z-10 overflow-hidden">
                <form action="{{ route('semi-finished-usage-requests.process', $materialUsageRequest) }}" method="POST">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mt-2">Anda yakin ingin memproses permintaan ini? Bahan-bahan akan
                            disiapkan.</p>
                        <div class="mt-4">
                            <label class="block text-sm text-gray-700">Catatan (Opsional)</label>
            ...
            <div class="relative bg-white rounded-xl shadow-xl max-w-lg w-full z-10 overflow-hidden">
                <form action="{{ route('semi-finished-usage-requests.complete', $materialUsageRequest) }}" method="POST">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mt-2">Tindakan ini akan mengurangi stok bahan dan tidak dapat
                            dibatalkan.</p>
                        <div class="mt-4">
                            <label class="block text-sm text-gray-700">Catatan (Opsional)</label>
            ...
            <div class="relative bg-white rounded-xl shadow-xl max-w-lg w-full z-10 overflow-hidden">
                <form action="{{ route('semi-finished-usage-requests.cancel', $materialUsageRequest) }}" method="POST">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mt-2">Anda yakin ingin membatalkan permintaan penggunaan bahan
                            #{{ $materialUsageRequest->request_number }}?</p>
                        <div class="mt-4">
                    ...
                    <div class="px-6 py-3 bg-gray-50 flex justify-end gap-3">
                        <button type="button" onclick="closeModal('cancelModal')"
                            class="px-4 py-2 rounded-md bg-white border">Tidak</button>
