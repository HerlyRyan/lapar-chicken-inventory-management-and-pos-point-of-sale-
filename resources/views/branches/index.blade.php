...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50/30 to-red-50/30">
        {{-- Page Header --}}
        <x-index.header title="Cabang" addRoute="{{ route('branches.create') }}" />
                                ...
                                @forelse($branches as $branch)
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <x-index.action-buttons :viewUrl="route('branches.show', $branch->id)" :editUrl="route('branches.edit', $branch->id)" :deleteUrl="route('branches.destroy', $branch->id)"
