...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            {{-- Header Section --}}
            <x-form.header title="Cabang" backRoute="{{ route('branches.index') }}" />

            {{-- Main Form Card --}}
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                {{-- Card Header --}}
                <x-form.card-header title="Tambah Cabang" type="add" />
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="lg:col-span-2">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name') }}" required placeholder="Contoh: Lapar Chicken Panjer">
                                    <p class="mt-2 text-sm text-gray-600">
                                        <i class="bi bi-info-circle mr-1"></i>Contoh: Lapar Chicken Panjer, Renon, dll.
                                    </p>
                                    @error('name')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code" id="code" maxlength="5"
                                        ...
                                        value="{{ old('code') }}" required placeholder="Contoh: PNJ, RNN">
                                    <p class="mt-2 text-sm text-gray-600">
                                        <i class="bi bi-info-circle mr-1"></i>3-5 karakter unik untuk identifikasi cabang
                                    </p>
                                    @error('code')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    <label for="type" class="block text-sm font-semibold text-gray-700 mb-2">
                                        Tipe Cabang <span class="text-red-500">*</span>
                                    </label>
                                    <select name="type" id="type"
                                        ...
                                        <option value="branch" {{ old('type', 'branch') == 'branch' ? 'selected' : '' }}>
                                            Cabang Retail</option>
                                        <option value="production" {{ old('type') == 'production' ? 'selected' : '' }}>Pusat
                                            Produksi</option>
                                    </select>
                                    <p class="mt-2 text-sm text-gray-600">
                                        <i class="bi bi-info-circle mr-1"></i>Pusat Produksi untuk lokasi produksi dan
                                        distribusi
                                    </p>
                                    @error('type')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div class="lg:col-span-2">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">
                                        <i class="bi bi-info-circle mr-1"></i>Opsional. Alamat lengkap cabang
                                    </p>
                                    @error('address')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <input type="text" name="phone" id="phone"
                                            ...
                                            value="{{ old('phone') }}" placeholder="813xxxxxxxx"
                                            oninput="formatPhoneNumber(this)" maxlength="15">
                                    </div>
                                    <p class="mt-2 text-sm text-gray-600">
                                        <i class="bi bi-info-circle mr-1"></i>Nomor telepon cabang dengan format 62 (ex:
                                        812...)
                                    </p>
                                    @error('phone')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email"
                                        ...
                                        value="{{ old('email') }}" placeholder="cabang@contoh.com">
                                    <p class="mt-2 text-sm text-gray-600">
                                        <i class="bi bi-info-circle mr-1"></i>Opsional. Email cabang
                                    </p>
                                    @error('email')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                        ...
                                        <label class="flex items-center cursor-pointer">
                                            ...
                                            <span class="ml-3">
                                                ...
                                                <span class="block text-xs text-gray-600 mt-1">
                                                    <i class="bi bi-info-circle mr-1"></i>Centang jika cabang masih
                                                    beroperasi
                                                </span>
                                            </span>
                                        </label>
