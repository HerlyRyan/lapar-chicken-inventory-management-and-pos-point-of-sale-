...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-green-50/30 to-emerald-50/30">
        {{-- Page Header --}}
        <x-index.header title="Produk Siap Jual">            
        </x-index.header>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
            <div x-data="sortableTable(@js($finishedProducts))" @sort-column.window="sortBy($event.detail)"
                ...
                {{-- Filter Section --}}
                <x-filter-bar searchPlaceholder="Cari nama, kode, atau deskripsi produk siap jual..." :selects="$selects ?? []" print="true" printRouteName="reports.finished.print" />
