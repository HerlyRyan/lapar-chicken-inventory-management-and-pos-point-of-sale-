                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div x-data="{
                                            ...
                                            canEdit: ['partial', 'accepted', 'rejected'].includes(receipt.status)
                                        }">
                        ...
                        <div class="p-4 hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <div class="mt-4 pt-3 border-t border-gray-200">
                                <div x-data="{
                                    ...
                                    <div class="flex items-center gap-2">
                                        <a :href="viewUrl"
                                            class="flex-1 inline-flex items-center justify-center px-3 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <button @click="confirmDelete(receipt.id, itemName)"
                                            class="inline-flex items-center justify-center px-3 py-2 text-red-600 hover:bg-red-50 border border-red-200 rounded-lg transition-colors duration-200">
